                   ...
                   // Log.d(TAG, response.body().string());
                    ...
                    if (checkBean.getStatus().getCode() == 1){
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(CheckActivity.this, "识别成功", Toast.LENGTH_SHORT).show();
                            }
                        });
                        Log.d(TAG, "识别成功");
                        Intent intent = CheckResultActivity.newIntent(CheckActivity.this);
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                Toast.makeText(CheckActivity.this, "识别失败", Toast.LENGTH_SHORT).show();
                            }
                        });
                        Log.d(TAG, "识别失败");
                        Intent intent = CheckResultActivity.newIntent(CheckActivity.this);
